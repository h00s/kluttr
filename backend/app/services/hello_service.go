// Package services contains all service implementations for the application.
// Each service is responsible for handling specific business logic and can be injected into controllers or other services as needed.
package services
